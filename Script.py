...
strike_ce = [(last_price_0 + 100 * factor) for factor in range(65)]
strike_ce = [(last_price_0 - 100)] + strike_ce
strike_pe = [(last_price_0 - 100 * factor) for factor in range(65)]
...
def supertrend(period: int = 10, multiplier: int = 4) -> float:
    ...
    if profit1[0] > 0 and profit1[1] > 0:
        ...
        # if sti['SUPERTd_10_2.0'].iloc[-1] == sti['SUPERTd_10_2.0'].iloc[-2] and sti['SUPERTd_10_2.0'].iloc[-1] == client.get_flags().future:
        #     print('Trend is same as before for 2.0')
        ...
        # if sti['SUPERTd_10_3.0'].iloc[-1] == sti['SUPERTd_10_3.0'].iloc[-2] and sti['SUPERTd_10_3.0'].iloc[-1] == client.get_flags().future:
        #     print('Trend is same as before for 3.0')
        ...
        for current_trade in client.get_trades():
            ...
            if current_ltp == 0:
                ...
                if current_trade.rank in ('Call 0', 'Put 0', 'Call 1', 'Put 1'):
                    ...
                    elif (wednesday == 1 or (wednesday == 2 and shortweek == 1)) and datetime.now().time() > time( 13, 30):
                        next_expiry(client, current_trade)
                    else:
